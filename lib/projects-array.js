...
export const reactProjects = [
  {
    ...
    description: 'A link shortening service that includes custom URLs.',
    delay: 0
  },
  {
    id: 'fooddata',
    ...
    description:
      'A service for getting nutrient profile data of requested food from USDA Food Database with API.',
    delay: 0
  },
  {
    id: 'search-npm',

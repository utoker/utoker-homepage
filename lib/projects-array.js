...
import thumbLaunchKit from '../public/images/projects/launchkit_eyecatch.png'
...
export const reactNativeProjects = [
  {
    ...
    description:
      "Food Check is a simple barcode grocery scanner that lets you quickly discover a food's ingredients.",
    delay: 0
  }
]
...
export const reactProjects = [
  {
    id: 'launchkit',
    title: 'LaunchKit',
    thumbnail: thumbLaunchKit,
    description:
      'A production SaaS boilerplate with per-user data isolation (PostgreSQL RLS), a full Stripe subscription lifecycle, and streaming AI chat powered by Claude.',
    delay: 0
  },
  {
    id: 'coldtrace',
    ...
    description:
      'IoT monitoring dashboard for vaccine cold chains. Real-time data over WebSockets and Redis PubSub, visualized with Recharts, plus a high-fidelity Node.js simulation engine.',
    delay: 0
  },
  {
    id: 'albert-solver',
    ...
    description:
      "This project provides an assistance with essays and homework using cutting-edge AI technology, powered by OpenAI's GPT-3 language model.",
    delay: 0
  },
  {
    id: 'link-shortener',
    ...
    description:
      'An easy-to-use link shortening service with an option to use custom URLs.',
    delay: 0
  },
  {
    id: 'food-data',
    ...
    description:
      'A service for getting nutrient profile data of requested food from USDA Food Database with Rest API.',
    delay: 0
  },
  {
    id: 'search-npm',
    ...
    description:
      'A web app for searching node packages with the implementation of npms.io Rest API.',
    delay: 0.1
  },
  {
    id: 'resume-builder',
    ...
    description:
      'A React app which allows users to create their own resume and save it as a PDF file.',
    delay: 0.1
  },
  {
    id: 'book-order-app',
    ...
    description: 'A shopping cart app built with React and Redux',
    delay: 0.2
  },
  {
    id: 'memory-game',
    ...
    description: 'A React app for playing a memory game.',
    delay: 0.2
  },
  {
    id: 'food-order-app',
    ...
    description: 'A shopping cart app built with React useReducer',
    delay: 0.3
  },
  {
    id: 'todo-app',
    ...
    description: 'A TypeScript React app for creating to do list.',
    delay: 0.3
  }
]
...
export const vanillaJsProjects = [
  {
    ...
    description: 'A calculator web app made with vanilla JavaScript.',
    delay: 0.4
  },
  {
    id: 'tic-tac-toe',
    ...
    description: 'A mini tic tac toe game made with vanilla JavaScript.',
    delay: 0.4
  },
  {
    id: 'etch-a-sketch',
    ...
    description: 'A mini paint app made with vanilla JavaScript.',
    delay: 0.5
  },
  {
    id: 'shopping-list',
    ...
    description: 'A shopping list web app made with vanilla JavaScript.',
    delay: 0.5
  }
]

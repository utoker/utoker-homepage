...
export const reactProjects = [
  {
    ...
    description:
      'IoT monitoring dashboard for vaccine cold chains. Features real-time data visualization (D3.js), GraphQL subscriptions, and a high-fidelity simulation engine.',
    delay: 0
  },
  {
    id: 'albert-solver',
